//! gapes-server library surface.
//!
//! This crate also produces the `gapes-server` binary; the library exists to
...
//!
//! The bin (main.rs) re-imports these modules via `gapes_server::*` rather
