...
impl AuditAction {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            AuditAction::PageAccessChange => "page.access_change",
            AuditAction::PageZoneChange => "page.zone_change",
...
impl FromStr for AuditAction {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "page.access_change" => Ok(AuditAction::PageAccessChange),
            "page.zone_change" => Ok(AuditAction::PageZoneChange),
