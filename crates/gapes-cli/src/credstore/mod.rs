...
//!   4. Chmod-600 TOML file at `~/.config/gapes/auth.toml`
//!   5. `GAPES_REFRESH_TOKEN` env var (overrides everything when set)
...
/// `env::EnvStore` short-circuits — if `GAPES_REFRESH_TOKEN` is set, we
