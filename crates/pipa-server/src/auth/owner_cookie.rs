...
use pipa_core::device::OwnerSession;
use hmac::{Hmac, Mac};
use sha2::Sha256;
...
pub const COOKIE_NAME: &str = "pipa_owner";
...
/// Read the `pipa_owner` cookie from a request, ignoring other cookies.
