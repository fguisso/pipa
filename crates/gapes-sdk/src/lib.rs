//! gapes HTTP API client. Wraps the JSON / multipart endpoints exposed by
//! `gapes-server` so a third-party tool can script deploys, list pages, manage
//! comments, etc. The CLI (`gapes-cli`) is the first consumer.
//!
